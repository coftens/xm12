...
import {
  Shield, ShieldAlert, Flame, FileSearch, Users, KeyRound, Settings, ChevronLeft, ChevronRight
} from 'lucide-react'
...
import { AccessControlPage, KeyManagementPage, SecuritySettingsPage } from './security/PlaceholderPages'
...
const navItems = [
  ...
  { id: 'access', label: '访问控制', icon: Users, description: '管理用户角色和访问权限' },
  { id: 'keys', label: '密钥管理', icon: KeyRound, description: '管理 API 密钥、证书和凭证' },
  { id: 'settings', label: '安全设置', icon: Settings, description: '配置全局安全策略' },
]
          ...
          {navItems.map(item => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex items-center gap-3 rounded-lg px-2.5 py-2 text-sm transition-colors text-left w-full',
                  isActive
